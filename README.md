...
- Method 2 - If you are currently not using aliases the copy the example [.bash_aliases](https://github.com/GrayHatGuy/dockery/blob/main/.bash_alias) included to $HOME
